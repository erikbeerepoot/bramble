...
function NodeList() {
  ...
  const visibleNodes = hideOffline ? onlineNodes : nodes;
      ...
      {visibleNodes.length === 0 ? (
        <div className="card text-center py-12">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900">
            {hideOffline ? 'No online nodes' : 'No nodes found'}
          </h3>
          <p className="mt-1 text-sm text-gray-500">
            {hideOffline
              ? 'All nodes are currently offline. Uncheck "Hide offline" to see them.'
