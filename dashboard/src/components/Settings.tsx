  ...
  return (
    <div className="max-w-lg">
      ...
      <div className="card">
        ...
        <div className="space-y-4">
          ...
          <div className="flex space-x-3">
            <button onClick={handleTest} disabled={testing || !url} className="btn btn-secondary">
              {testing ? 'Testing...' : 'Test Connection'}
            </button>
            <button onClick={handleSave} disabled={!url} className="btn btn-primary">
              Save & Return
            </button>
          </div>
        </div>
      ...
      <div className="card mt-4">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-300">Bramble Dashboard v0.1.0</p>
